...
import MiddleEastDisplay from "./MiddleEastDisplay";

interface MiddleEastProps {
  sessionToken: string | null;
}

interface MiddleEastState {
  blogs: [BlogJSON];
...
class MiddleEast extends React.Component<MiddleEastProps, MiddleEastState> {
  constructor(props: MiddleEastProps) {
    super(props);
    this.state = {
      blogs: [
        {
